    ...
    <div className="max-w-4xl mx-auto px-5 sm:px-8 py-8 sm:py-10">
      ...
      {filterExperienceId && (
        <div className="flex items-center justify-between mb-6 gap-3 flex-wrap">
          <p className="text-[13px] text-rd-text-secondary">
            Showing stories for <strong className="text-rd-text font-display font-bold">{filterExperienceLabel}</strong>
          </p>
          <button
            type="button"
      ...
      {storiesLoading ? (
        ...
        <div className="rounded-[18px] border border-rd-border bg-rd-bg-card px-6 py-12 shadow-rd text-center">
          ...
          <p className="font-display font-bold text-[15px] text-rd-text">No stories captured yet.</p>
          ...
          {experiences.length > 0 ? (
            ...
            <p className="text-[12px] text-rd-text-tertiary mt-5">
              ...
              <a href="/Profile?tab=experience" className="underline hover:text-rd-coral-dark">Profile</a>{" "}
              first, then capture stories tied to it.
            </p>
          )}
        </div>
      ) : filteredStories.length === 0 ? (
        <div className="rounded-[18px] border border-rd-border bg-rd-bg-card px-6 py-8 shadow-rd text-center">
          <p className="text-[13px] text-rd-text-secondary">No stories match this filter.</p>
        </div>
      ) : (
