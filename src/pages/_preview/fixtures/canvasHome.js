...
function mkJob(o) {
  return {
    ...
    company_slug: null,
    // Real registered domain, mirroring what companyDomainFor() resolves in prod
    // (JobGridCard passes it to CompanyLogo). Real IL-tech domains resolve to real
    // favicons via the tokenless DuckDuckGo tier — no fabricated marks, no token.
    company_domain: o.domain || null,
