// CanvasTexture - re-export of the canonical GrainGround (single source of truth,
// 2026-07-18). The grain now lives in components/redesign/GrainGround so the canvas
...
export { default } from "@/components/redesign/GrainGround";
