export const agentDecisionLogic = {
  ...
  "description": "Determines Track 1, Track 2, and Track 3 role recommendations by combining readiness, goal alignment, user preference, adjacent-field viability, and role quality thresholds.",
  "core_track_definitions": {
    "track_1": "Best immediate next move: strong enough fit now and strongest alignment to the 5-year goal.",
    "track_2": "Viable now, but less aligned path.",
    "track_3": "More aligned to the long-term goal, but usually one step ahead of current readiness."
  },
  "decision_inputs": {
    "user_inputs": [
      "five_year_role",
  ...
  "track_rules": {
    "track_1": {
      "requirements": [
        ...
        "small stretch roles are not allowed in Track 1"
      ],
      "disqualifiers": [
    ...
    "track_2": {
      "requirements": [
        "role is viable now",
        "role has lower long-term alignment than Track 1 options",
    ...
    "track_3": {
      ...
      "rule": "If a role is highly aligned but the user is not properly ready yet, it stays Track 3."
    }
  },
  ...
  "selection_logic": {
    ...
    "step_3": "Assign Track 1 to roles with strong immediate readiness and strongest long-term alignment.",
    "step_4": "Assign Track 2 to roles that are viable now but less aligned than Track 1.",
    "step_5": "Assign Track 3 to roles that are more aligned to the future but are not fully realistic yet.",
  ...
  "quality_thresholds": {
    "track_1_min_readiness": 0.72,
    "track_1_min_alignment": 0.68,
    "track_2_min_readiness": 0.62,
    "track_3_min_alignment": 0.72,
  ...
  "conflict_resolution_rules": [
    "If a role is highly aligned but not truly gettable now, place it in Track 3.",
    "If a role is highly gettable now but weakly aligned, place it in Track 2.",
    "If a role is both highly gettable now and strongly aligned, place it in Track 1.",
